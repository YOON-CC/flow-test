  ...
  return (
    <>
      <div className="w-[670px] flex justify-between items-center mb-3 pb-3">
        <div className="text-sm font-semibold text-gray-900 bg-blue-100 py-3 px-5 rounded-lg border border-blue-500">
          리서치 섹션명
        </div>
      ...
      <div className="relative w-[670px]">
        <div className="relative w-fit rounded-2xl border border-blue-300">
          <div className="py-5 px-6 rounded-t-2xl bg-blue-50">
          ...
          <div className="py-5 px-6 rounded-b-2xl bg-blue-50">
          ...
          <Handle 
            ...
            style={{ left: -10 }}
            className="w-2.5 h-2.5 rounded-full border-2 border-white opacity-80 bg-blue-500 hover:bg-blue-600 hover:opacity-100 hover:scale-110 transition-all"
          />
          <Handle 
            type="source" 
